...
// tether-scanner-mcp's ToolDescriptionAuditor).  We intentionally keep
// this dependency-free so tether-mcp-proxy only needs tether-core.
// ---------------------------------------------------------------------------
                        ...
                        if denied_tools.contains(tool_name) {
                            ...
                            let error_response = serde_json::json!({
                                ...
                                "error": {
                                    "code": -32600,
                                    "message": format!(
                                        "tool '{}' is denied by tether policy",
                                        tool_name
                                    )
                                }
                            });
